  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          if (gamemode=="single")...[
           Padding(
             ...
             child: Text("Vælg modstander", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold),),
           ),
        ...
        Padding(
             padding: const EdgeInsets.only(top: 32),
             child: Text("Vælg holdkammerat", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold),),
           ),
        ...
        Padding(
          ...
          return DropdownMenuItem<String>(
           ...
           Padding(
             padding: const EdgeInsets.only(top: 32),
             child: Text("Vælg tidspunkt", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold),),
           ),
