...
class _ConfirmState extends State<Confirm> {
 ...
 onPressed: () {    
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => Date(teammate: widget.teammate, court: widget.court, single_or_double: widget.single_or_double, gamemode: widget.gamemode, op1: widget.op1, op2: widget.op2,) ));   
